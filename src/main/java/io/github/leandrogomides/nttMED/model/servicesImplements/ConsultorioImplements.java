...
import io.github.leandrogomides.nttMED.controllers.MedicoController;
...
//        listaConsultorio.add(new Consultorio(++id, consultorio.getMedico()));
        listaConsultorio.add(new Consultorio(consultorio.getId(), consultorio.getData(), consultorio.getConsultas()));
